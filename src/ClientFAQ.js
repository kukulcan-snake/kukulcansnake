...
const FAQs = [
    {"question": "訂購商品並成功付款後，需幾天的時間才能收到商品？", "answer": "每週五發貨，週六到貨，可以指定周一到貨。特殊節慶等繁盛期誤差1～3日。"},
    ...
    {"question": "布丁可以放幾天？", "answer": "冷藏條件完好的情況下是十天歐:D"},
    {"question": "如果要週五以外時間配達需要支付額外費用嗎？", "answer": "宅配極限為兩日工作日，需增加20％費用。當日自取需增加50％費用。"},
